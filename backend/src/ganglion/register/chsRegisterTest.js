...
router.post('/', (req, res) => {
	...
	chsRegNum = req.body.chsRegNum -2 ;
	console.log("chs; hello register"+chsRegNum+" "+arrLenth)


	//delete from LOGINEOGFP1 where userNum=4;
...
function fp1(fpdata) {
	...
	if (checkDB == true && inputDB == false) {
		...
		var Stringquery = "delete from LOGINEOGFP1 where userNum=" + userNum + ";"
		client.query(Stringquery);

		Stringquery = "INSERT INTO LOGINEOGFP1 VALUES(" + userNum + ", " + min_mp + ", " + max_mp + ", " + min_mn + ", " + max_mn + ", " + min_ips + ", " + max_ips + ", " + min_ins + ", " + max_ins + ", " + min_sop + ", " + max_sop + ", " + min_son + ", " + max_son + ", " + min_sfp + ", " + max_sfp + ", " + min_sfn + ", " + max_sfn + ", " + min_dp + ", " + max_dp + ", " + min_dn + ", " + max_dn + ");";
		console.log(Stringquery)
		client.query(Stringquery);
		inputDB = true;
		return 4
	...
	else if (arrLenth >= chsRegNum && checkDB == false) {
		resultArr.forEach((y) => {
...
function fp2(fpdata) {
	...
	if (checkDB_fp2 == true && inputDB_fp2 == false) {
		...
		var Stringquery = "delete from LOGINEOGFP2 where userNum=" + userNum + ";"
		client.query(Stringquery);

		Stringquery = "INSERT INTO LOGINEOGFP2 VALUES(" + userNum + ", " + min_mp + ", " + max_mp + ", " + min_mn + ", " + max_mn + ", " + min_ips + ", " + max_ips + ", " + min_ins + ", " + max_ins + ", " + min_sop + ", " + max_sop + ", " + min_son + ", " + max_son + ", " + min_sfp + ", " + max_sfp + ", " + min_sfn + ", " + max_sfn + ", " + min_dp + ", " + max_dp + ", " + min_dn + ", " + max_dn + ");";
		console.log(Stringquery)
		client.query(Stringquery);
		inputDB_fp2 = true;
		return 4
	...
	else if (arrLenth_fp2 >= chsRegNum && checkDB_fp2 == false) {
...
function fp1_mkArray(result) {
	resultArr[arrLenth++] = result;
