	...
	if(req.body.status == "start"){
      ...
      fs.readFile('data_'+req.body.userNum+'.txt', 'utf8', (err, data)=>{
        if(serviceArr.length <= 10){
          ...
          serviceArr[serviceArr.length] = arr_sleep[arr_sleep.length-2];
        }
        else{
