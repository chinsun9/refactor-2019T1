...
router.post('/', (req, res) => {
    fs.readFile('./data.txt', 'utf8', (error, data) =>{
      console.log(req.body.token_java)
    if(error){
      console.log(error);
    }
    if(data){
      tempString = data.toString().split(' ');
      if(checkToken == false){
        if(tempString[0]+"\n" == req.body.token_java){
      ...
      if(tempString[0]+"\n" == req.body.token_java && req.body.token_java != null){
...
function fp1(fpdata) {
  ...
  if(checkDB == true && inputDB == false){
    ...
    var Stringquery = "INSERT INTO LOGINEOGFP1 VALUES("+ tempString[1] + ", " + min_mp  + ", " + max_mp + ", " + min_mn + ", " + max_mn + ", " + min_ips + ", " + max_ips + ", " + min_ins + ", " + max_ins + ", " + min_sop + ", " + max_sop + ", " + min_son + ", " + max_son + ", " + min_sfp + ", " + max_sfp + ", " + min_sfn + ", " + max_sfn + ", " + min_dp + ", " + max_dp + ", " + min_dn + ", " + max_dn + ");";
  ...
  else if(arrLenth >= 10 && checkDB == false){
    resultArr.forEach( (y) => {
...
function fp2(fpdata) {
  if(checkDB_fp2 == true && inputDB_fp2 == false){
    ...
    var Stringquery = "INSERT INTO LOGINEOGFP2 VALUES("+ tempString[1] + ", " + min_mp  + ", " + max_mp + ", " + min_mn + ", " + max_mn + ", " + min_ips + ", " + max_ips + ", " + min_ins + ", " + max_ins + ", " + min_sop + ", " + max_sop + ", " + min_son + ", " + max_son + ", " + min_sfp + ", " + max_sfp + ", " + min_sfn + ", " + max_sfn + ", " + min_dp + ", " + max_dp + ", " + min_dn + ", " + max_dn + ");";
    client.query(Stringquery);
    inputDB_fp2 = true;
    return 4
  }
  ...
  else if(arrLenth_fp2 >= 10 && checkDB_fp2 == false){
