...
// 첫번째놈 그래프로 그리기 == 데이터 덮어쓰기
  ...
  //그래프 타이틀 변경
  $("#content > div > div:nth-child(2) > div.col-xl-8.col-lg-7 > div > div.card-header.py-3.d-flex.flex-row.align-items-center.justify-content-between > h6")[0].innerHTML = input.dname;
}
